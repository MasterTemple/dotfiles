...
alias sl="ls"
alias cppr="g++ main.cpp -o main && ./main" # run cpp main file
...
__conda_setup="$('/home/dgmastertemple/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/dgmastertemple/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/dgmastertemple/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/dgmastertemple/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# fnm
export PATH="/home/dglinuxtemple/.local/share/fnm:$PATH"
eval "`fnm env`"

# find file with fzf then open with nvim
fzfnvim() {
	fzf --preview 'cat {}' | xargs nvim
}
alias f="fzfnvim"
