...
# NOTE: I must move go here from home directory
...
# wget https://github.com/WebAssembly/wasi-sdk/releases/download/wasi-sdk-30/wasi-sdk-30.0-x86_64-linux.tar.gz
# tar -xzf wasi-sdk-30.0-x86_64-linux.tar.gz -C $HOME
export WASI_SDK_PATH=$HOME/wasi-sdk-30.0
# 2️⃣ Add the WASI clang to PATH
